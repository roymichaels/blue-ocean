...
// Simple in-memory key-value store used for tests and local development
// In a real deployment this would interface with a NEAR smart contract or
// NEAR Lake indexer. The API mirrors the former tonKvStore for compatibility.
