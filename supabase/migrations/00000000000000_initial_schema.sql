-- file: 20250629105628_blue_fog.sql
/*
...
CREATE TRIGGER update_user_profiles_updated_at 
  ...
  FOR EACH ROW EXECUTE FUNCTION update_updated_at_column();
-- file: 20250629105649_dusty_dune.sql
/*
  # Insert Sample Data
...
ON CONFLICT (id) DO NOTHING;
-- file: 20250629110835_wispy_stream.sql
/*
...
CREATE TRIGGER update_user_profiles_updated_at 
  BEFORE UPDATE ON user_profiles 
  FOR EACH ROW EXECUTE FUNCTION update_updated_at_column();
-- file: 20250629110855_rough_band.sql
/*
  # Insert Sample Data
...
INSERT INTO chat_messages (id, room_id, sender_id, sender_name, message, timestamp, is_admin) VALUES
  ...
  ('msg_4', 'default_room', 'admin', 'Admin', 'Welcome to our store! How can I help you today?', EXTRACT(EPOCH FROM now() - INTERVAL '1 hour') * 1000, true)
ON CONFLICT (id) DO NOTHING;
-- file: 20250629114730_throbbing_queen.sql
...
ON CONFLICT DO NOTHING;
-- file: 20250629115849_navy_swamp.sql
/*
...
ON CONFLICT (id) DO NOTHING;
-- file: 20250629122933_summer_sky.sql
/*
...
ON CONFLICT DO NOTHING;
-- file: 20250629124711_mute_fountain.sql
...
-- file: 20250630002423_polished_sky.sql
/*
...
-- file: 20250630013601_maroon_term.sql
/*
...
-- file: 20250630013605_ancient_gate.sql
/*
...
-- file: 20250630013607_proud_tree.sql
/*
...
-- file: 20250630024044_silver_moon.sql
/*
...
-- file: 20250630025023_silver_lodge.sql
...
-- file: 20250630054710_morning_harbor.sql
/*
...
-- file: 20250630231707_young_darkness.sql
/*
...
-- file: 20250701041602_green_fog.sql
/*
...
-- file: 20250701043227_odd_stream.sql
/*
...
-- file: 20250701052016_curly_stream.sql
-- Fix column name in products table (original_price -> originalPrice)
DO $$ 
BEGIN
  -- Check if the column exists before attempting to rename
...
BEGIN
  ...
  END IF;
END $$;
-- file: 20250701052542_square_flame.sql
/*
...
END;
$$ LANGUAGE plpgsql SECURITY DEFINER;
-- file: 20250701053247_sweet_bread.sql
-- Fix column name in products table (original_price -> originalPrice)
DO $$ 
BEGIN
  -- Check if the column exists before attempting to rename
...
END;
$$ LANGUAGE plpgsql SECURITY DEFINER;
-- file: 20250701054429_turquoise_crystal.sql
/*
...
CREATE POLICY "Admin delete access for hero_banners" 
  ...
  TO public 
  USING (true);
-- file: 20250701065326_tender_shape.sql
/*
...
-- file: 20250701084852_fancy_boat.sql
/*
...
-- file: 20250701101416_noisy_credit.sql
/*
...
ON CONFLICT (id) DO NOTHING;
-- file: 20250701102729_precious_pebble.sql
/*
...
-- file: 20250701144138_proud_shore.sql
/*
...
WHERE id = 'wholesale';
-- file: 20250701191235_rough_peak.sql
/*
...
CREATE POLICY "Anonymous can access chat messages" 
  ...
  USING (true) 
  WITH CHECK (true);
-- file: 20250701192847_round_bar.sql
/*
...
CREATE POLICY "Anyone can access chat messages"
  ...
  USING (true)
  WITH CHECK (true);
-- file: 20250701193902_lively_sky.sql
-- Drop existing policies for chat_rooms
DROP POLICY IF EXISTS "Users can read their own chat rooms" ON chat_rooms;
DROP POLICY IF EXISTS "Admin can read all chat rooms" ON chat_rooms;
DROP POLICY IF EXISTS "Users can insert chat rooms" ON chat_rooms;
...
CREATE POLICY "Anyone can access chat messages"
  ...
  USING (true)
  WITH CHECK (true);
-- file: 20250701194120_broken_spire.sql
/*
...
BEGIN
  ...
  CREATE POLICY "Anyone can access chat messages"
    ...
    WITH CHECK (true);
END $$;
-- file: 20250701195155_bronze_smoke.sql
/*
  # Fix Chat RLS Policies
...
BEGIN
  ...
  END IF;
END $$;
-- file: 20250701195427_lingering_firefly.sql
-- Safely drop and recreate policies for chat_rooms
DO $$ 
BEGIN
...
BEGIN
  ...
  END;
END $$;
-- file: 20250701195900_price_tier_rules.sql
...
-- file: 20250702010000_crimson_mix.sql
/*
...
-- file: 20250702130000_wishlist_items.sql
/*
...
-- file: 20250702133000_peach_route.sql
/*
...
-- file: 20250703160000_allow_driver_role.sql
/*
...
-- file: 20250704000000_platform_info.sql
/*
...
-- file: 20250704120000_branding_settings.sql
/*
...
-- file: 20250704130000_tenant_settings.sql
/*
...
-- file: 20250704140000_user_pins.sql
/*
...
-- file: 20250704150000_user_pins.sql
/*
