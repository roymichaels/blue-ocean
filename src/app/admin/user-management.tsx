...
export default function UserManagementScreen() {
  ...
  const [editedRole, setEditedRole] = useState<'user' | 'driver' | 'admin'>(
    'user'
  );
        ...
        prev.map((u) =>
          u.id === selectedUser.id
            ? {
                ...
                isDriver: editedRole === 'driver',
                customerTier: editedTier,
              }
            : u
        )
      );
    ...
    >
        ...
        <View style={styles.userBadges}>
          {user.role === 'admin' && (
            <View style={[styles.roleBadge, { backgroundColor: colors.gold }]}>
              <Text
                style={[styles.roleBadgeText, { color: colors.text.inverse }]}
              >
                מנהל
              </Text>
            </View>
          ...
          <View
            style={[
              styles.tierBadge,
              { backgroundColor: getCustomerTierColor(user.customerTier) },
            ]}
          >
            <Text
              style={[styles.tierBadgeText, { color: colors.text.inverse }]}
            >
      ...
      <View style={styles.userDetails}>
        <View style={styles.userDetailRow}>
          ...
          <Text
            style={[styles.userDetailText, { color: colors.text.secondary }]}
          >
            ...
            {selectedUser && (
              <View style={styles.modalContent}>
                ...
                <Text
                  style={[
                    styles.userDetailTitle,
                    { color: colors.text.primary, marginTop: 24 },
                  ]}
                >
                  הגדרות תפקיד
                </Text>
