...
export default function SettingsScreen() {
  ...
  const { currencySymbol: contextCurrencySymbol, setCurrencySymbol } =
    useCurrency();
      ...
      >
        ...
        >
          ...
          <View style={styles.settingContent}>
            ...
            <View
              style={[styles.comingSoonBadge, { backgroundColor: colors.gold }]}
            >
              <Text
                style={[styles.comingSoonText, { color: colors.text.inverse }]}
              >
                בקרוב
              </Text>
            </View>
