...
export default function SubcategoryScreen() {
  ...
  const [showSubcategoryEditModal, setShowSubcategoryEditModal] =
    useState(false);
  ...
  const saveSubcategoryChanges = async () => {
    ...
    try {
      ...
      setInfoModal({
        visible: true,
        title: 'שגיאה',
        message: 'עדכון תת-הקטגוריה נכשל',
        type: 'error',
      });
    } finally {
      setLoading(false);
  ...
  const deleteCurrentSubcategory = async () => {
    ...
    try {
      ...
      setInfoModal({
        visible: true,
        title: 'שגיאה',
        message: 'מחיקת תת-הקטגוריה נכשלה',
        type: 'error',
      });
    } finally {
      setLoading(false);
      ...
      <View style={styles.productInfo}>
        ...
        {item.pricingTier && (
          <View style={styles.pricingTierContainer}>
            <Text
              style={[styles.pricingTierText, { color: colors.text.secondary }]}
            >
              {pricingTiers.find((tier) => tier.id === item.pricingTier)
                ?.name || item.pricingTier}
            </Text>
          </View>
        )}
        ...
        <View style={styles.stockContainer}>
          <View
            style={[
              ...
              {
                backgroundColor:
                  item.stock > 0 ? colors.status.success : colors.status.error,
              },
            ]}
          />
          ...
          <View style={styles.emptyContainer}>
            ...
            <Text style={[styles.emptyText, { color: colors.text.secondary }]}>
              {isAdmin
                ...
                : 'אנחנו עובדים על הוספת מוצרים לקטגוריה זו'}
            </Text>
            {isAdmin && (
              <TouchableOpacity
          ...
          <ScrollView style={styles.modalContent}>
            ...
            <View style={styles.formGroup}>
              ...
              <TextInput
                ...
                onChangeText={(text) =>
                  setNewProduct({
                    ...newProduct,
                    originalPrice: parseFloat(text) || undefined,
                  })
                }
              ...
              >
                ...
                >
                  {newProduct.pricingTier
                    ? pricingTiers.find((t) => t.id === newProduct.pricingTier)
                        ?.name || newProduct.pricingTier
                    : 'בחר מדרג מחירים'}
                </Text>
              </TouchableOpacity>
              <Text
            ...
            <View style={styles.formGroup}>
              ...
              >
                ...
                >
                  {newProduct.category
                    ? categories.find((c) => c.id === newProduct.category)
            ...
            <View style={styles.formGroup}>
              ...
              <TextInput
                ...
                onChangeText={(text) =>
                  setNewProduct({ ...newProduct, stock: parseInt(text) || 0 })
                }
      ...
      >
        ...
        >
          ...
          >
            ...
            <TouchableOpacity
              onPress={() => setShowSubcategoryEditModal(false)}
            >
              <X size={24} color={colors.text.primary} />
            </TouchableOpacity>
          </View>
          ...
          <ScrollView style={styles.modalContent}>
            <View style={styles.formGroup}>
              ...
              <TextInput
                ...
                onChangeText={(text) =>
                  setEditSubcategoryData({ ...editSubcategoryData, name: text })
                }
            ...
            <View style={styles.formGroup}>
              ...
              <TextInput
                ...
                onChangeText={(text) =>
                  setEditSubcategoryData({ ...editSubcategoryData, icon: text })
                }
        ...
        <View style={styles.categorySelectorOverlay}>
          ...
          >
            <View style={styles.categorySelectorHeader}>
              ...
              <TouchableOpacity
                onPress={() => setShowPricingTierSelector(false)}
              >
                <X size={24} color={colors.text.primary} />
              </TouchableOpacity>
            </View>
              ...
              {pricingTiers.map((tier) => (
                ...
                >
                  <View style={styles.categorySelectorItemContent}>
                    <Text
                      style={[
                        styles.pricingTierDiscount,
                        { color: colors.gold },
                      ]}
                    >
                      {typeof tier.pricePerUnit === 'number'
                        ? `מחיר ליחידה: ${currencySymbol}${tier.pricePerUnit.toFixed(
                            2
                          )}`
                        : 'מחיר רגיל'}
                    </Text>
