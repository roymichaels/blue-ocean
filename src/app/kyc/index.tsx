...
export default function KycScreen() {
  ...
  const confirmSkipRequest = () => {
    ...
    setConfirmModal({
      ...
      message:
        'האם אתה בטוח שברצונך לבקש לדלג על תהליך האימות? בקשה זו תיבדק על ידי מנהל.',
      ...
      <ScrollView style={styles.content} showsVerticalScrollIndicator={false}>
        ...
        >
          ...
          <View style={styles.statusContent}>
            ...
            >
              {kycStatus === 'none' &&
                'אימות KYC נדרש כדי לבצע הזמנות. אנא השלם את תהליך האימות.'}
              {kycStatus === 'pending' &&
                'בקשת האימות שלך נמצאת כרגע בבדיקה. נודיע לך ברגע שתעובד.'}
              {kycStatus === 'verified' &&
                'החשבון שלך מאומת. כעת תוכל לבצע הזמנות ולגשת לכל התכונות.'}
              {kycStatus === 'rejected' &&
                'בקשת האימות שלך נדחתה. אנא צור קשר עם התמיכה למידע נוסף.'}
            </Text>
          </View>
        </View>
        ...
        >
          <Text style={[styles.telegramTitle, { color: colors.text.primary }]}>
            צור קשר עם התמיכה בטלגרם
          </Text>
          <Text
            style={[
              styles.telegramDescription,
              { color: colors.text.secondary },
            ]}
          >
          ...
          <TouchableOpacity
            style={[styles.telegramButton, { backgroundColor: colors.gold }]}
        ...
        {(kycStatus === 'none' || kycStatus === 'rejected') && (
          ...
          >
            <Text style={[styles.requestTitle, { color: colors.text.primary }]}>
              בקש אימות
            </Text>
        ...
        >
          ...
          <Text style={[styles.infoText, { color: colors.text.secondary }]}>
            אימות KYC (Know Your Customer) הוא תהליך שבו אנו מאמתים את זהות
            הלקוחות שלנו. זה נדרש כדי לעמוד בדרישות הרגולטוריות ולהבטיח את
            בטיחות המשתמשים שלנו.
          </Text>
          <Text style={[styles.infoText, { color: colors.text.secondary }]}>
            לאחר שתגיש את בקשת האימות, צוות התמיכה שלנו יבדוק אותה ויעדכן את
            הסטטוס שלך. תהליך זה עשוי להימשך עד 24 שעות.
          </Text>
        </View>
      </ScrollView>
