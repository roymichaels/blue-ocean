...
export default function CategoryScreen() {
  ...
  const saveSubcategory = async () => {
    ...
    try {
      ...
      setInfoModal({
        ...
        title: 'שגיאה',
        message:
          error instanceof Error ? error.message : 'שמירת תת-הקטגוריה נכשלה',
        type: 'error',
      });
    } finally {
      setLoading(false);
  ...
  const deleteSubcategory = async (subcategoryId: string) => {
    ...
    try {
      ...
      setInfoModal({
        ...
        title: 'שגיאה',
        message:
          error instanceof Error ? error.message : 'מחיקת תת-הקטגוריה נכשלה',
        type: 'error',
      });
    } finally {
      setLoading(false);
  ...
  const renderSubcategory = (item: Subcategory) => (
    ...
    >
      ...
      <Text style={[styles.subcategoryName, { color: colors.text.primary }]}>
        {item.name}
      </Text>
        ...
        {subcategories.length > 0 ? (
          ...
          <View style={styles.emptyContainer}>
            ...
            <Text style={[styles.emptyText, { color: colors.text.secondary }]}>
              {isAdmin
                ? 'הוסף תת-קטגוריות כדי להתחיל'
                : 'תת-קטגוריות יתווספו בקרוב'}
            </Text>
            {isAdmin && (
              <TouchableOpacity
          ...
          <ScrollView style={styles.modalContent}>
            <View style={styles.formGroup}>
              ...
              <TextInput
                ...
                onChangeText={(text) =>
                  setNewSubcategory({ ...newSubcategory, id: text })
                }
            ...
            <View style={styles.formGroup}>
              ...
              <TextInput
                ...
                onChangeText={(text) =>
                  setNewSubcategory({ ...newSubcategory, icon: text })
                }
