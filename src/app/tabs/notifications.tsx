  ...
  const renderNotification = (item: Notification) => (
    ...
    >
      ...
      <View style={styles.notificationContent}>
        ...
        <Text
          style={[styles.notificationTime, { color: colors.text.tertiary }]}
        >
    ...
    >
      ...
      >
        ...
        {notifications.length > 0 && (
          <TouchableOpacity onPress={markAllAsRead}>
            <Text style={[styles.markAllRead, { color: colors.gold }]}>
      ...
      {isAdmin && (
        <View style={[styles.adminBanner, { backgroundColor: colors.gold }]}>
          ...
          <Text
            style={[styles.adminBannerText, { color: colors.text.inverse }]}
          >
            {t('notifications.adminNotifications')}
          </Text>
        </View>
      )}
      ...
      >
        ...
        >
          ...
          {notifications.filter((n) => !n.read).length > 0 && (
            ...
            >
              <Text
                style={[styles.unreadBadgeText, { color: colors.text.primary }]}
              >
      ...
      {loading ? (
        ...
        <View style={styles.emptyContainer}>
          ...
          >
            <Text
              style={[styles.loginButtonText, { color: colors.text.inverse }]}
            >
              {t('auth.login')}
            </Text>
          </TouchableOpacity>
